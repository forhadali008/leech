...
async def set_password_zip(message):
    ...
    if passdata is None:
        ...
        if str(message.sender_id) == passdata[0]:
            ...
            await message.reply("𝙿𝚊𝚜𝚜𝚠𝚘𝚛𝚍 𝚞𝚙𝚍𝚊𝚝𝚎𝚍 𝚜𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢.")
        else:
            await message.reply("𝙲𝚊𝚗𝚗𝚘𝚝 𝚞𝚙𝚍𝚊𝚝𝚎 𝚝𝚑𝚎 𝚙𝚊𝚜𝚜𝚠𝚘𝚛𝚍 𝚝𝚑𝚒𝚜 𝚒𝚜 𝚗𝚘𝚝 𝚢𝚘𝚞𝚛 𝚍𝚘𝚠𝚗𝚕𝚘𝚊𝚍.")
...
async def about_me(message):
    ...
    if val1 is not None:
        leen = "⚠️𝙻𝚎𝚎𝚌𝚑 𝙲𝚘𝚖𝚖𝚊𝚗𝚍 𝙴𝚗𝚊𝚋𝚕𝚎𝚍." if val1 else "⚠️𝙻𝚎𝚎𝚌𝚑 𝙲𝚘𝚖𝚖𝚊𝚗𝚍 𝙳𝚒𝚜𝚊𝚋𝚕𝚎𝚍."
    else:
        leen = "N/A"
